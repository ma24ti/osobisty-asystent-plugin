#!/usr/bin/env python3
# KOPIA WSPÓLNA — identyczne egzemplarze: reflect, kontekst-sygnaly, kontekst-firmowy.
# Zmiany nanoś we WSZYSTKICH trzech (memory-update ma własny, rozjechany wariant).
"""
